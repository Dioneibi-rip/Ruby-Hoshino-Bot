import { loadHarem, saveHarem, isSameUserId } from '../../infra/gacha-group.js'
import { loadCharacters } from '../../infra/gacha-characters.js'
import { normalizeProtectionDuration, formatProtectionDate, isProtectionActive, getUserFunds, spendUserFunds, getBaseProtectionPrice, getProtectionRenewalPlan, applyProtection, MAX_PROTECTION_DAYS } from '../../infra/gacha-protection.js'
