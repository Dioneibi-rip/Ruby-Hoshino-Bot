...
if (column === 'meta_json') patch[column] = safeJsonString(value)
...
sqlite.prepare(`
INSERT INTO bot_profiles(session_id, bot_jid, owner_jid, bot_name, custom_prefix, menu_video_url, menu_image_url, welcome_image_url, goodbye_image_url, welcome_enabled, goodbye_enabled, meta_json, created_at, updated_at)
VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
ON CONFLICT(session_id) DO NOTHING
`).run(base.session_id, base.bot_jid, base.owner_jid, base.bot_name, base.custom_prefix, base.menu_video_url, base.menu_image_url, base.welcome_image_url, base.goodbye_image_url, base.welcome_enabled, base.goodbye_enabled, base.meta_json, base.created_at, base.updated_at)
