...
{ nombre: '🔮 Encuentro con una Hechicera', coin: 7000, exp: 350, health: +10, mensaje: 'Una hechicera te bendijo con riquezas y experiencia.' },
...
{ nombre: '🏹 Cazador Errante', coin: 5500, exp: 275, health: 0, mensaje: 'Un cazador te regaló provisiones por ayudarlo.' },
{ nombre: '💎 Piedra Épica del Alma', coin: 22500, exp: 625, health: 0, mensaje: `¡Una piedra mágica explotó en riqueza de ${m.moneda}!` },
{ nombre: '🌿 Curandera del Bosque', coin: 1250, exp: 225, health: +30, mensaje: 'Una mujer misteriosa sanó tus heridas con magia natural.' },
{ nombre: '🪙 Mercader Ambulante', coin: 9000, exp: 325, health: 0, mensaje: 'Vendiste objetos recolectados y ganaste buenas monedas.' },
{ nombre: '🧌 Troll del Puente', coin: -14000, exp: 500, health: -15, mensaje: 'El troll te cobró peaje... a golpes.' },
{ nombre: '🗺️ Mapa de un Explorador Perdido', coin: 13000, exp: 425, health: 0, mensaje: 'Encontraste un mapa secreto con una gran recompensa.' },
