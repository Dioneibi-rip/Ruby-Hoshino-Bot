...
// <-- Número @s.whatsapp.net -->
  ...
  ['51968892918', 'Neo-Dey', true],
  ['51975640571', 'ू⃪ ꒰˘͈ᵕ ˘͈ mari-𝒄𝒉𝒂𝒏 🪽 ꒱𖦹', true], 
  ['51925468457', 'Flavi',true],

// <-- Número @lid -->
  ['51906278352', 'Deyner', true],
  ['51932884973', 'Rip-D͙ey', true],
  ['51968892918', 'Neo-Dey', true],
  ['51975640571', 'Mari', true],
  ['51925468457', 'Flavi',true],
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "51932884973-51968892918@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: packname, orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
global.ch = {
