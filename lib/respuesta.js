...
const handler = async (type, conn, m, comando) => {
  ...
  if (msg) {
    ...
    // Descargamos la imagen como buffer (igual que en el play)
    try {
    ...
    // Definimos el link que usaremos tanto en mediaUrl como en sourceUrl
    const enlaceOficial = typeof redes !== 'undefined' ? redes : 'https://github.com/Dioneibi-rip';
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        ...
        body: 'I🎀 𓈒꒰ 𝐘𝐚𝐲~ 𝐇𝐨𝐥𝐚𝐚𝐚! (≧∇≦)/',
        mediaType: 1, 
        thumbnail: thumbBuffer, // Pasamos el buffer
        renderLargerThumbnail: false,
        mediaUrl: enlaceOficial, // ¡AQUÍ ESTÁ LA MAGIA FALTANTE!
        sourceUrl: enlaceOficial // Mismo enlace que mediaUrl
      }
    };
