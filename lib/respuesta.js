...
const iconos = [
  ...
  // ⚠️ Corregido: usar raw.githubusercontent.com, no github.com/blob/
...
/**
 * Descarga la imagen aleatoria y la devuelve como Buffer.
 * Si falla, devuelve null.
 */
const getRandomThumbnail = async () => {
  try {
    ...
    console.error('[Ruby Hoshino] Error cargando miniatura:', e)
    return null
  }
}
...
💖 ¡Así podré reconocerte~! (⁎˃ᴗ˂⁎)`,
  ...
  // Obtener miniatura aleatoria
  const thumbnail = await getRandomThumbnail()
  ...
  return conn.sendMessage(
    m.chat,
    {
      ...
      contextInfo: {
        ...
        // ✨ Tarjeta con icono aleatorio
        externalAdReply: {
          title: packname,
          body: `✦ Comando: ${comando || 'Desconocido'}`,
          thumbnail, // Buffer descargado
          mediaType: 1,
