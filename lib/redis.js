...
export const redisUrl = 'rediss://default:gQAAAAAAAdpPAAIgcDIyMzhiNTI5M2ZlZTA0ZDQwYTJmMmUxMzhjYWZmYmRhNw@climbing-stinkbug-121423.upstash.io:6379'
const redisOptions = {
lazyConnect: false,
...
return `cooldown:${jid}:${String(command || '').toLowerCase()}`
}
