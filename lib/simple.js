...
function getMessageContextInfo(node) {
if (!node || typeof node !== 'object') return null
if (node.contextInfo) return node.contextInfo
if (node.message && typeof node.message === 'object') return getMessageContextInfo(node.message)
for (const value of Object.values(node)) {
if (!value || typeof value !== 'object') continue
const found = getMessageContextInfo(value)
...
const mentionedJid = getMessageContextInfo(source)?.mentionedJid
if (Array.isArray(mentionedJid) && mentionedJid.length) return mentionedJid
}
return []
}
...
return mentionedJid.length ? mentionedJid : self.getQuotedObj()?.mentionedJid || []
        ...
        mentionedJid: {
            get() {
                return getMessageMentionedJid(this.message, this.msg)
            },
            enumerable: true
        },
        name: {
