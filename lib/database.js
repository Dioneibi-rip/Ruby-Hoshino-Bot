...
export class DbManager {
  ...
  listUsers() { return Object.fromEntries(Object.keys(this.listRecords('users')).map((jid) => [jid, this.getUser(jid)])) }
  listChats() { return this.listRecords('chats', chatDefault) }
  listSettings() { return this.listRecords('settings', settingsDefault) }
