...
`)
  ...
  _bindPublicApi() {
    for (const name of ['getUser', 'updateUser', 'userExists', 'listUsers', 'listUserRows', 'addMoney', 'addEconomy', 'setEconomy', 'incrementUserField', 'getSection', 'replaceSection', 'setMarriagePair', 'divorcePair', 'getMarriages', 'replaceMarriages', 'getHarem', 'replaceHarem', 'upsertHaremClaim', 'get', 'set', 'has', 'delete', 'read', 'write', 'flush', 'close', 'snapshot']) {
