...
addColumnIfMissing(this.sqlite, table, 'value', `value TEXT NOT NULL DEFAULT '{}'`)
addColumnIfMissing(this.sqlite, table, 'updated_at', 'updated_at INTEGER NOT NULL DEFAULT 0')
}
}
